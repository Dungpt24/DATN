...
"background-color: qlineargradient(spread:pad, x1:0.636826, y1:1, x2:0.627025, y2:0.102, stop:0 rgba(0, 200, 237, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.let_phonenumber = QtWidgets.QLineEdit(self.frame_2)
        self.let_phonenumber.setGeometry(QtCore.QRect(1240, 510, 241, 51))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.let_phonenumber.setFont(font)
        self.let_phonenumber.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.let_phonenumber.setAlignment(QtCore.Qt.AlignCenter)
        self.let_phonenumber.setObjectName("let_phonenumber")
...
"font-size: 18px")
    ...
    def retranslateUi(self, Frame):
        ...
        self.label_8.setText(_translate("Frame", "SĐT"))
